                    ...
                    <div class="grid gap-6 mb-8 md:grid-cols-1 xl:grid-cols-3">
                        ...
                        <a href="{{ route('users') }}">
                            <div class="flex items-center p-4 bg-white rounded-lg shadow-xs hover:bg-pr-200  ">
                                <div class="p-3 mr-4 bg-gray-400 rounded-full ">
                            ...
                            <table class="w-full whitespace-no-wrap overflow-scroll table-auto">
                                <thead>
                                    <tr
                                        ...
                                        <th class="px-4 py-3 w-48">Mobil disewa</th>
                                        <th class="px-4 py-3 w-24">Mulai</th>
                                        <th class="px-4 py-3 w-24">Akhir</th>
                                        <th class="px-4 py-3">Durasi</th>
                                        <th class="px-4 py-3 w-26">Sisa Hari</th>
                                ...
                                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                    ...
                                    @forelse ($reservations as $reservation)
                                        <tr class="text-gray-700 dark:text-gray-400">
                                            ...
                                            <td class="px-4 py-3 text-sm">
                                                {{ $reservation->car->price_per_day * $reservation->days }} IDR
                                            </td>
