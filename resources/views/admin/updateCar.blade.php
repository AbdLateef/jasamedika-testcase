        ...
        <form class=" w-full" action="{{ route('cars.update', ['car' => $car->id]) }}" method="POST"
            ...
            <div class="md:w-2/3 w-5/6 md:px-24 px-4 pb-8 mx-auto mt-2 space-y-12 bg-white border-2 border-gray-600 rounded-md">
                <div class=" border-b border-gray-900/10 pb-12">
                    <h2 class="mt-2 text-center font-bold text-lg leading-7 text-gray-900">Updating mobil:
                        <span> {{ $car->brand }} {{ $car->model }} {{ $car->engine }}</span></h2>
                    ...
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div class="sm:col-span-2">
                            <label for="price_per_day" class="block text-sm font-medium leading-6 text-gray-900">Sewa per hari</label>
                            <div class="mt-2">
                ...
                <a href="{{route('cars.index')}}"
                        class="w-20 p-1 text-sm font-semibold leading-6 text-center text-gray-900 border-2 rounded-md border-gray-200 hover:bg-white bg-sec-300">Batal</a>
                    <button type="submit"
                        class="w-1/3 rounded-md bg-gray-400 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-gray-600">Simpan</button>
                </div>
