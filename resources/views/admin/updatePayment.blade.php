...
<body>
    <div class="bg-gray-200 flex justify-center items-center h-screen">
        <div class="bg-white p-6 rounded-md md:w-1/3 w-full mx-4">
            ...
            <h2 class="text-start mt-4 text-gray-500 ">Payment Status saat ini: <span
            ...
            <div>
                <form action="{{ route('updatePayment', ['reservation' => $reservation->id]) }}" method="POST">
                    ...
                    <div class="my-5 w-full flex items-center">
                        <label class="w-44" for="payment_status">Update menjadi: </label>
                        <select
                    ...
                    <div class="flex justify-center mt-12">
                        ...
                        <button type="submit" class="p-3 w-full text-white rounded-md bg-blue-500 hover:bg-blue-700">Simpan</button>
                    </div>
                </form>
            </div>
